const CrypTOR = require('.');

const crypTOR = new CrypTOR();
/**
 * Change the message and private key variables to experiment with the function
 * @example
 * // message: "Your message",
 * // privateKey: "jWnZr4u7QeThWmZq+MbQeShVD(G+KbPe!A%D*G-Kt7w!z%C*Yq3t6w9zgVkYp3s6PdRgUkXp-JaNdRfU"
 */
